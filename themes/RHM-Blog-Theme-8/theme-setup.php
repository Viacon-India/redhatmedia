...
if(!function_exists('custom_setup'))
{
	  function custom_setup()
	  {
          ...
          $template_array = array(
            ...
            array(
              'new_page_title' => 'Brands',
              'new_page_template' => 'page-template/brand-page.php',
            ),    
            array(
              'new_page_title' => 'Services',
              'new_page_template' => 'page-template/service-page.php',
            ),
            array(
              'new_page_title' => 'Contact Us',
              'new_page_template' => 'page-template/contact-page.php',
            ),
            array(
              'new_page_title' => 'News',
              'new_page_template' => 'page-template/news-page.php',
            ), 
          );
