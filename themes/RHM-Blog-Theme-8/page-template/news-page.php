...
$google_arr = get_posts(array('posts_per_page' => 3, 'post_type' => 'news', 
  'tax_query' => array(
    array(
      'taxonomy' => 'news-cat',
      'field' => 'term_id',
...
$digital_arr = get_posts(array('posts_per_page' => 3, 'post_type' => 'news', 
  'tax_query' => array(
    array(
      'taxonomy' => 'news-cat',
      'field' => 'term_id',
...
$social_arr = get_posts(array('posts_per_page' => 3, 'post_type' => 'news', 
  'tax_query' => array(
    array(
      'taxonomy' => 'news-cat',
      'field' => 'term_id',
