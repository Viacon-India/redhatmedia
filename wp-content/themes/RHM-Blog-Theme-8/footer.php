...
<!-- start footer  -->
<footer class="footer" style="    width: 100%;padding: calc(50px + 3vmin) 0;background: url(<?php echo get_template_directory_uri(); ?>/assets/images/background-1.png);background-repeat: no-repeat;-o-object-fit: cover;object-fit: cover;background-size: cover;background-position: right;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="brand-link-wrapper">
            ...
            <?php if (!empty($branddata[0])) {
              foreach ($branddata[0] as $data) {
                if (!empty($data['name'])) { ?>
                  <a class="brand-link" target="_blank" href="<?php if (!empty($data['link'])) {
                                                                echo $data['link'];
                                                              } ?>">
                    <?php echo $data['name']; ?>
                  </a>
...
<!-- <script src="<?php //echo get_template_directory_uri(); 
                  ?>/assets/scripts/script.js"></script>
  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha256-4+XzXVhsDmqanXGHaHvgh1gMQKX40OUvDEBTu8JcmNs=" crossorigin="anonymous"></script>
  <script src="<?php //echo get_template_directory_uri(); 
                ?>/assets/scripts/bootstrap.bundle.min.js"></script> -->
